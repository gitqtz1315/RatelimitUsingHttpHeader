...
public enum RateLimitType {
    ...
    /**
     * Rate limit policy considering an Http Header (Key : Value)
     */
    HTTP_HEADER {
        public boolean apply(HttpServletRequest request, Route route, RateLimitUtils rateLimitUtils, String matcher) {
            if(!matcher.contains(":")) {
            ...
            String[] keyAndValueInHttpHeader = matcher.split(":", 2);
            return request.getHeader(keyAndValueInHttpHeader[0]).equals(keyAndValueInHttpHeader[1]);
        }
