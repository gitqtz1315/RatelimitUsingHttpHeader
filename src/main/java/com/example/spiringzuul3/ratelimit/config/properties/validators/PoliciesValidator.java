...
package com.example.spiringzuul3.ratelimit.config.properties.validators;
...
public class PoliciesValidator implements ConstraintValidator<Policies, Object> {
    ...
    private boolean isValidObject(Object o) {
        return (o instanceof RateLimitProperties.Policy) && isValidPolicy((RateLimitProperties.Policy) o);
    }
    ...
    private boolean isValid(RateLimitProperties.Policy policy) {
