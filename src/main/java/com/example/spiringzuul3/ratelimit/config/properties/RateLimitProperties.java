...
import static com.example.spiringzuul3.ratelimit.config.properties.ResponseHeadersVerbosity.NONE;
import static com.example.spiringzuul3.ratelimit.config.properties.ResponseHeadersVerbosity.VERBOSE;
...
public class RateLimitProperties implements Serializable {
    ...
    Map<String, List<Policy>> copiedPolicyList;
...
//    }
    public List<Policy> getPolicies(String key) {
        if(copiedPolicyList == null) {
            copiedPolicyList = policyList;
        }
        return copiedPolicyList.getOrDefault(key, defaultPolicyList);
    }

    public synchronized void updatePolicyList(Map<String, List<Policy>> policyList) {
        copiedPolicyList = Map.copyOf(policyList);
    }
    ...
    public static class Policy implements Serializable {
        ...
        public static class MatchType implements Serializable {
            ...
            public String key(HttpServletRequest request, Route route, RateLimitUtils rateLimitUtils) {
                if(type.equals(RateLimitType.HTTP_HEADER)) {
    ...
    public static class DenyRequest implements Serializable{
